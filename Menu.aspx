                            ...
                            <div class="info-card col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                ...
                                <div class="back">
                                    ...
                                    <div class="addToCartButton">
                                        <asp:Label   ID="lblprice" style="color:white"    runat="server"  Text='<%# Eval("food_cost").ToString().Insert(Eval("food_cost").ToString().IndexOf("-") + 1,"$") %>' />
                                        <input           id="Button2" Descr='<%# Eval("food_descr") %>'             runat="server" value="View" type="button"      class="btn btn-sm btn-danger text-center" chooseDetail='<%# ((HtmlInputButton)sender).NamingContainer.FindControl("hidFoodID").ClientID %>'/>
